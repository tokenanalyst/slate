...
```shell
curl "https://api.tokenanalyst.io/analytics/private/v1/exchange_flow_window_historical/last?format=json&token=btc&exchange=binance&direction=inflow&window=1h&key=API_KEY"
```
...
[
  {
    ...
    "datetime": "2017-08-16 11:00:00", // not avilabale when window 1d
    "inflow": 1053.89,
  ...
  },
  {
    ...
    "date": "2017-08-17",
    "hour": "11:00:00", // not avilabale when window 1d
    "timestamp": "2017-08-17 11:00:00", // not avilabale when window 1d
    "inflow": 2236.29,
...
[
  {
    ...
    "date": "2017-07-05",
    "hour": "11:00:00", // not avilabale when window 1d
    "datetime": "2017-07-05 11:00:00", // not avilabale when window 1d
  ...
  },
  {
    ...
    "date": "2017-07-12",
    "hour": "11:00:00", // not avilabale when window 1d
    "datetime": "2017-07-12 11:00:00", // not avilabale when window 1d
