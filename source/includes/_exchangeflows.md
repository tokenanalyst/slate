...
| Stablecoin                  | Symbol        | Supported Exchanges                                       |
|-----------------------------|---------------|-----------------------------------------------------------|
| Tether (Omni)               | `usdt_omni`   | `bittrex`, `bitfinex`, `kraken`, `okex`, `poloniex`       |
| Tether (ERC20)              | `usdt_erc20`  | `binance`, `bittrex`, `bitfinex`, `kucoin`, `poloniex`    |
| USDC                        | `usdc`        | `bittrex`, `bitfinex`                                     |
| Paxos Standard Token        | `pax`         | `binance`, `bittrex`, `bitfinex`                          |
...
| token        | _string_  | A token from the table that we support                                                    |
...
| Field             | Type      | Description                                                                                                                           |
| ----------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| avg_txn_value     | _decimal_ | The average amount BTC/ETH transferred per transaction out of the given exchange to another exchange on this date.                    |
